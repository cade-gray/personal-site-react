    ...
    return(
        <div className = 'projects-container'>
            <div className='project-list-container'>
                ...
                />
                <Project className='project-comp' imgURL={[vaultairePic]} projName="The Vault" githubLink={false}
                ...
                />
                <Project imgURL={[MHHPic1,MHHPic2]} projName="Muse Hall Hop" githubLink={false}
